...
lastmod: '2023-10-29'
tags: ['excel', 'vba']
images: ['/static/images/common/excel-vba.jpg']
summary: Excel VBA テンプレートファイルを作成しました。クラスモジュールを中心に、Excelテーブルと連携したDB（Oracle）のCRUD操作等の機能を実装しています。
---
...
<TOCInline toc={props.toc} exclude="概要" />
...
![sample](/static/blog/52/1-sample.png)
...
![config](/static/blog/52/2-config.png)
