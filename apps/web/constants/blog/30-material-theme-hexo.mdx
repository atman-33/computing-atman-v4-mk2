...
date: '2023-03-04'
tags: ['hexo', 'material-design']
images: ['/static/blog/30/1.png']
summary: Hexo に マテリアルテーマを適用する方法
---
...
▼テーマ_config.yml  
![image](/static/blog/30/6.png)

▼テーマ_config.yml  
![image](/static/blog/30/7.png)
...
▼テーマ_config.yml  
![image](/static/blog/30/9.png)

### ページのJavaScriptエフェクト

▼テーマ_config.yml  
![image](/static/blog/30/10.png)

### 投稿ページ要旨の単語数

▼テーマ_config.yml  
![image](/static/blog/30/11.png)
...
▼ルート_config.yml  
![image](/static/blog/30/15.png)

▼テーマ_config.yml  
![image](/static/blog/30/16.png)

hanabi 表示効果のサンプルを載せてきます。  
![image](/static/blog/30/17.png)
...
▼テーマ_config.yml  
![image](/static/blog/30/19.png)

この設定の場合、下記のように表示されます。

![image](/static/blog/30/20.png)
