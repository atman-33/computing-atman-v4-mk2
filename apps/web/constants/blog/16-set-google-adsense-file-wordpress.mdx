...
date: '2020-03-14'
images: ['/static/blog/16/google-adsense-alert.png']
tags: ['word-press', 'google-adsense']
summary: WordPress における ads.txt の設置方法
---

Google AdSense を使っていると、自分のログインページに下記のようなアラートが表示されることがあります

![image](/static/blog/16/google-adsense-alert.png)
...
![image](/static/blog/16/advanced-file-manager.png)
...
![image](/static/blog/16/wordpress-file-manager.png)
