...
draft: false
images: ['/static/blog/9/thumbnail.png']
summary: I tried creating a 'shooting game' using CreateJS and classes (object-oriented).
---
...
![image](/static/blog/9/thumbnail.png)
