...
date: '2023-03-11'
tags: ['c sharp', 'xamarin', 'prism template pack']
images: ['/static/blog/33/1.png']
summary: Visual Studioで、Prismの「Xamarin Forms」を利用時、UWPプロジェクトのビルドが通らずエラーが発生する際の対処方法
---
