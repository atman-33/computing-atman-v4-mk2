...
images: ['/static/blog/22/00.png']
summary: Excelマクロ 第2回：[SELECT文により取得したデータをExcelに格納]
---
...
![image](/static/blog/22/03.png)

![image](/static/blog/22/04.png)
