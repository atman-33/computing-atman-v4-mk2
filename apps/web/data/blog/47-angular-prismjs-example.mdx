...
date: '2023-07-17'
tags: ['angular', 'css', 'prism js']
images: ['/static/blog/47/1.png']
summary: Here is how to apply prismjs to your code in Angular.By following this method, you will be able to apply prismjs to HTML stored in a database and display it on an Angular page.  
---
