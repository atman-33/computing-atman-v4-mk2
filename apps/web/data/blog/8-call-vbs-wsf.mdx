...
tags: ['wsf', 'vbs']
draft: false
images: ['/static/blog/8/package.png']
summary: I will explain how to use it as a package to call multiple VBS files together using WSF.
---
...
![image](/static/blog/8/package.png)
