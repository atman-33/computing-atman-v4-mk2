...
date: '2020-04-01'
tags: ['aws', 'ssh']
images: ['/static/blog/18/aws_system.png']
summary: AWSクラウドサービスに対して、SSH接続を利用してローカルPCから踏み台サーバー経由でDBサーバーに接続し、MySQL Workbench を用いてDBを操作する方法
---
...
![image](/static/blog/18/aws_system.png)
...
#### .sshフォルダの中身
![image](/static/blog/18/ssh_folder.png)
...
#### AWS MySQL DBへの接続設定  
![image](/static/blog/18/mysql_workbench_connect.png)
