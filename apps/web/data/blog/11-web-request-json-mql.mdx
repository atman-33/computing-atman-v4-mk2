...
images: ['/static/blog/11/add_url.png']
summary: This is an article about MQL, a language used for FX trading in MetaTrader 4 (MT4).In this article, we will introduce how to send JSON data using the WebRequest function to make requests to a web server.
---
...
![image](/static/blog/11/add_url.png)
