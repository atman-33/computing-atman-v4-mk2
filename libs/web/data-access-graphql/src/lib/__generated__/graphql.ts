...
export type GetSampleTodosQuery = {
  sampleTodos: Array<{ _id: string; content: string; editing: boolean; completed: boolean }>;
};
...
export type CreateSampleTodoMutation = {
  createSampleTodo: { _id: string; content: string; editing: boolean; completed: boolean };
};
...
export type UpdateSampleTodoMutation = {
  updateSampleTodo: { _id: string; content: string; editing: boolean; completed: boolean };
};
...
export type CreateBookmarkMutation = {
  createBookmark: { _id: string; name: string; userId: string };
};

export type GetBookmarksQueryVariables = Exact<{ [key: string]: never }>;

export type GetBookmarksQuery = {
  bookmarks: Array<{ _id: string; name: string; userId: string; links: Array<string> }>;
};
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'createUserData' } },
          type: {
            kind: 'NonNullType',
            ...
            arguments: [
              {
                ...
                value: { kind: 'Variable', name: { kind: 'Name', value: 'createUserData' } }
              }
            ],
            selectionSet: {
              kind: 'SelectionSet',
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'createBookmarkData' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'CreateBookmarkInput' } }
          }
        }
      ],
      selectionSet: {
        ...
        selections: [
          {
            ...
            arguments: [
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'createBookmarkData' },
                value: { kind: 'Variable', name: { kind: 'Name', value: 'createBookmarkData' } }
              }
            ],
            selectionSet: {
              kind: 'SelectionSet',
...
} as unknown as DocumentNode<GetBookmarksQuery, GetBookmarksQueryVariables>;
