 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation createBookmark($data: BookmarkCreateInput!) {\n  createBookmark(data: $data) {\n    id\n    name\n    userId\n  }\n}\n\nquery getBookmarks {\n  bookmarks {\n    id\n    name\n    userId\n    links\n  }\n}\n\nquery getBookmark($where: BookmarkWhereUniqueInput!) {\n  bookmark(where: $where) {\n    id\n    name\n    userId\n    links\n  }\n}\n\nmutation updateBookmark($data: BookmarkUpdateInput!, $where: BookmarkWhereUniqueInput!) {\n  updateBookmark(data: $data, where: $where) {\n    id\n    name\n    userId\n    links\n  }\n}\n\nmutation deleteBookmark($where: BookmarkWhereUniqueInput!) {\n  deleteBookmark(where: $where) {\n    id\n  }\n}"): (typeof documents)["mutation createBookmark($data: BookmarkCreateInput!) {\n  createBookmark(data: $data) {\n    id\n    name\n    userId\n  }\n}\n\nquery getBookmarks {\n  bookmarks {\n    id\n    name\n    userId\n    links\n  }\n}\n\nquery getBookmark($where: BookmarkWhereUniqueInput!) {\n  bookmark(where: $where) {\n    id\n    name\n    userId\n    links\n  }\n}\n\nmutation updateBookmark($data: BookmarkUpdateInput!, $where: BookmarkWhereUniqueInput!) {\n  updateBookmark(data: $data, where: $where) {\n    id\n    name\n    userId\n    links\n  }\n}\n\nmutation deleteBookmark($where: BookmarkWhereUniqueInput!) {\n  deleteBookmark(where: $where) {\n    id\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
